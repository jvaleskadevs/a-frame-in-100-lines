...
function readData() {
  return JSON.parse(fs.readFileSync(process.cwd() + '/app/results/results.json', 'utf8'));
}

function writeData(data: any) {
  fs.writeFileSync(process.cwd() + '/app/results/results.json', JSON.stringify(data, null, 4));
}
